	...
	const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	UAbilityTask_PlayMontageAndWait* PlayAttackTask = UAbilityTask_PlayMontageAndWait::CreatePlayMontageAndWaitProxy(
		this, "PlayAttack", ABCharacter->GetComboActionMontage(), 1.0f, GetNextSection());
...
// ActivateAbility가 호출되고 동작하는 중에 다시 입력이 들어왔을 때 호출
...
void UABGA_Attack::StartComboTimer()
{
	...
	if (ComboEffectiveTime > 0.0f) // 0초보다 크다면 콤보가 존재하므로 타이머 설정
	{
...
{
	ComboTimerHandle.Invalidate(); // 타이머 무력화
